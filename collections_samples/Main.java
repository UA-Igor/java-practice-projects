...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Read 1st element from list " + list.get(0));
        System.out.println("Read 2nd element from list " + list.get(1));
        ...
        System.out.println("Read 2nd element from array " + arr.get(2));
        arr.remove(2);
        arr.print();
        System.out.println("Array contains 3.14 " + arr.contains(3.14));
        arr.print();
